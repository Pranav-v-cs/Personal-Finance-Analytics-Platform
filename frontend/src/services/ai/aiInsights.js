...
export async function generateExplainBudget(budget, data) {
...
export async function generateExplainAnomaly(txn, avgExpense, data) {
  const context = buildFinancialContext(data)
...
export async function generateSavingsOpportunities(data) {
  const context = buildFinancialContext(data)
